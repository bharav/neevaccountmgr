(function () {
    angular.module("NeevAccountApp").controller("SearchController", ['$scope', '$rootScope', '$location', 'AccountService', SearchController]);


    function SearchController($scope, $rootScope, $location, AccountService) {
